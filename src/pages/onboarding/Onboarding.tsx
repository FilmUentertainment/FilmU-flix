      ...
      {showModal && (
        <PopupModal
          ...
          message={
            <div>
              <p>
                FilmU doesn’t host videos. It relies on third-party websites.
                ...
                <br />
                Uses FilmU’s built-in proxy. It’s the easiest option but might
                be slower due to shared bandwidth.
                <br />
                <br />
